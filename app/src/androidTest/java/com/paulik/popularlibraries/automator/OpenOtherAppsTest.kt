...
class OpenOtherAppsTest {
    ...
    fun test_OpenSettings() {
        ...
        //Устройство для которого писался этот тест (Android_Emulator - Pixel_2_Q_10_api),
        ...
        //Steps указывает, в какое количество шагов мы хотим осуществить смахивание:
        //чем выше число, тем медленнее будет осуществляться свайп
        uiDevice.swipe(500, 1500, 500, 0, 5)
//        можно использовать метод UiObject2.click() вместо UiDevice.swipe(),
//        чтобы нажать на конкретный элемент на экране.
        ...
        //Вполне возможно (встречается на старых устройствах), что приложения находятся на вкладке
        //Apps (будет еще вкладка Widgets).
